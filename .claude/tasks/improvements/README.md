...
|------|-------|-------------|--------|--------|
| [P1-01](P1-01-developer-self-access.md) | Developer Self-Access Tokens | — | Medium | |
| [P1-02](P1-02-actionable-dashboard.md) | Actionable Dashboard (Alerts + Grid + Deltas) | P1-05 | Medium | **Done** |
| [P1-03](P1-03-developer-self-goals.md) | Developer Self-Goal Creation | P1-01 | Small | |
| [P1-04](P1-04-structured-ai-rendering.md) | Structured AI Result Rendering | — | Medium | |
| [P1-05](P1-05-recharts-trend-viz.md) | Recharts + Trend Visualizations | — | Medium | **Done** |
| [P1-06](P1-06-frontend-polish.md) | Frontend Polish (Errors, Toasts, Skeletons) | — | Medium | |
| [P1-07](P1-07-draft-pr-filtering.md) | Draft PR Filtering + Workload Fix | — | Small | |
| [P1-08](P1-08-methodology-tooltips.md) | Methodology Tooltips | — | Small | |

## Phase 2: "Make It Smart" (New Computations from Existing Data)

| Task | Title | Dependencies | Effort |
|------|-------|-------------|--------|
| [P2-01](P2-01-stale-pr-endpoint.md) | Stale PR List Endpoint | P1-07 | Medium |
| [P2-02](P2-02-review-round-trips.md) | Review Round-Trip Count | — | Small |
| [P2-03](P2-03-approved-at-merge-latency.md) | Approved-At + Post-Approval Merge Latency | — | Small |
| [P2-04](P2-04-issue-pr-linkage.md) | Issue-to-PR Linkage (Closing Keywords) | — | Medium |
| [P2-05](P2-05-pr-metadata-capture.md) | Capture PR Labels, Merged-By, Branches | — | Small |
| [P2-06](P2-06-revert-detection.md) | Revert PR Detection | P2-05 | Small |
| [P2-07](P2-07-review-quality-algorithm-fix.md) | Fix Review Quality Algorithm | — | Small |
| [P2-08](P2-08-workload-collaboration-pages.md) | Workload + Collaboration + Benchmarks Pages | P1-05 | Large |
| [P2-09](P2-09-goals-page.md) | Goals Management Page | P1-05 | Medium |
...
| [P3-03](P3-03-issue-quality-scoring.md) | Issue Quality Scoring | P2-04 | Medium |
| [P3-04](P3-04-issue-creator-analytics.md) | Issue Creator Analytics (Mgmt Friction) | P3-03 | Medium |
| [P3-05](P3-05-pr-risk-scoring.md) | PR Risk Scoring | P2-05, P2-02 | Medium |
| [P3-06](P3-06-code-churn-analysis.md) | Code Churn Analysis (File-Level) | — | Large |
